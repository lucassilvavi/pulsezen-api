...
- Jantar leve 2h antes de dormir`,
  ...
  {
    id: uuidv4(),
    title: 'Hidratação e Bem-estar Mental',
    summary: 'A desidratação pode aumentar ansiedade. Aprenda a se hidratar corretamente.',
    content: `# Hidratação e Bem-estar Mental

Você sabia que a desidratação pode imitar ou intensificar sintomas de ansiedade?
...
### 🌅 Ao acordar:
- 1-2 copos de água em temperatura ambiente
- Adicione gotas de limão para vitamina C

### 🍃 Durante o dia:
- Água com pepino, hortelã ou frutas
- Chás de ervas (não substituem a água)
- Água de coco natural

### 🌙 À noite:
- Evite grandes quantidades 2h antes de dormir
- Chá de camomila conta para hidratação

## Monitoramento simples:
- Urina clara = bem hidratado
- Urina amarelo escuro = precisa beber mais água

## Aplicativos úteis:
Configure lembretes no celular a cada 2 horas.

**Lembre-se: sede é sinal tardio de desidratação!**`,
    category: 'nutrition',
    estimatedReadTime: 3,
